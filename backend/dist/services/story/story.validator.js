...
exports.validateReorientation = exports.validateResolution = exports.validateComplication = exports.validateOrientation = exports.validateJudul = exports.validateStory = void 0;
const stringValidators = __importStar(require("../../common/utils/validations/string.validator"));
const validateStory = (newStory) => {
    (0, exports.validateJudul)(newStory.judul);
    (0, exports.validateOrientation)(newStory.orientation);
    (0, exports.validateComplication)(newStory.complication);
    (0, exports.validateResolution)(newStory.resolution);
    (0, exports.validateReorientation)(newStory.reorientation);
};
