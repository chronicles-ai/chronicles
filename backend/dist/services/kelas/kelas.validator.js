...
exports.validateNamaKelas = exports.validateKelas = void 0;
const stringValidators = __importStar(require("../../common/utils/validations/string.validator"));
const validateKelas = (newKelas) => {
    (0, exports.validateNamaKelas)(newKelas.nama_kelas);
};
exports.validateKelas = validateKelas;
const validateNamaKelas = (nama_kelas) => {
...
exports.validateNamaKelas = validateNamaKelas;
